...
public class BusquedaWebTest {
	...
	public void busquedaNoExistente() {
		Assert.assertEquals("http://minifigbox.com/X9X357102", busquedaWeb.busquedaWeb("wasuwasa"));
	}
	
	@Test
	public void busquedaVacia() {
		Assert.assertEquals("https://www.google.com/doodles", busquedaWeb.busquedaWeb(""));
	}
